...
const Main = () => {
  ...
  const handleSearchButton = (e) => {
    ...
    const options = {
      method: "GET",
      url: `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${userInput}/?key=9HD6BSB4H5JGFQ6ZPCHV5J9YF&unitGroup=metric`,
    };
        ...
        <Container className="main-screen">
          <Row className="my-4">
            <Col className="text-center my-5" xs={12} md={!2}>
              <img src={image} alt="" style={{ width: "200px", height: "auto" }} className="logo" />
              <p
